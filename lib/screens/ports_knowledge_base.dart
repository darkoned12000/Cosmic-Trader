      ...
      body: ListView(
        ...
        children: [
          ...
          _sectionCard(
            ...
            'Hacking Mini-Game',
            [
              'Crack a unique 3-digit security code to gain access to port systems.',
              '',
              'How it works:',
              '• 5 code guesses per stage',
              '• 3 failed hacking sessions per port trigger a 24-hour ban',
              '• Locked digits turn green and stay fixed',
              '• Unique digits only — no repeats in the code',
              '• Type numbers directly or use the on-screen keypad',
              '• Backspace/Delete edits the code; Enter submits it',
              '',
              'Port security:',
              '• The live trace meter rises after incorrect submissions',
              '• Hardened ports use two code stages with a fresh guess counter',
              '• Security profiles vary by port class, ownership, and defense level',
              '• The terminal shows simulated packet traffic and a separate attempt log',
              '',
              'Extraction choices after success:',
              '• Conservative credits: 750–1,250 credits',
              '• Aggressive credits: 2,000–4,000 when trace is low; reduced at high trace',
              '• Resources: 10 units of cargo',
              '• Sabotage: 15 research points and a 30-minute 50% starting-shield reduction',
              ...
              '• 3rd failure: 5,000 credits + 24-hour ban',
              '• Ban state and failure count persist across logout and restart',
            ],
          ),
          const SizedBox(height: 12),
          _sectionCard(
